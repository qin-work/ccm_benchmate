...
def process_pdf(pdf, lp_model=lp_model, vl_model=vl_model, processor=processor, zoomx=2, device="cuda", max_tokens=400):
    figure_messages = [{"role": "system", "content": [{"type": "text",
         ...
         interpret the figure. Do not provide comments on whether the figure is well done or not. Do not provide extra text on describing that you are looking at figure from a scienfitic figure. 
    ...
    return article_text, figures, figure_interpretation
